                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu" >
                            ...
                            <li>
                            <a id="misActividades" href="#"><i class="fa fa-dashboard fa-fw"></i>Mis Actividades</a>
                        </li>
                            <li>
...
/*$i=0; */                              //  $contador = 0;
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#misActividades").click(function() {
                var nroEm = "<?php echo $nroEmpleado; ?>" ;
                //alert(nroEm);
                data2 = {nroEm: nroEm};
                $("#contenedorUsuarios").load('pages/calendarioSubActividadesDocente.php', data2);
            });

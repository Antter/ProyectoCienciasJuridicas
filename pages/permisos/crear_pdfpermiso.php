...
$pdf->Ln(7);
$pdf->Cell(150, 15, 'Unidad Academica: '.$result['nombre_departamento'], 0);
$pdf->Ln(7);
...
$pdf->Ln(7);
$pdf->Cell(125, 15, 'Duracion en dias: '.$result['dias_permiso'], 0,0,"");
$pdf->Ln(7);
...
$pdf->Cell(10, 10, '', 0);
$pdf->Cell(40, 15, 'Hora Finalizacion: '.$result['hora_finalizacion'], 0);
...
$pdf->Ln(7);
$pdf->Cell(180, 8, 'Seccion de Efectividad y Control', 0,0,"C");
$pdf->Ln(5);

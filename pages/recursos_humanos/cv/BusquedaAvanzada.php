    ...
    <head>    
           ...
           $("form").submit(function(e) {
            ...
            $.ajax({
                   async: true,
                    ...
                    contentType: "application/x-www-form-urlencoded",
                    beforeSend: busqueda,
                    success: llegadaBusquedaUniversidad,
                    timeout: 4000,
                    error: problemasbusqueda
            });
            return false;
	    ...
	    e.preventDefault();
            ...
            function llegadaBusqueda()
            {
              ...
              {
                  $("#contenedor2").load('pages/recursos_humanos/cv/consultaRH.php',data2);

              }

          function llegadaBusquedaUniversidad()
          {
              $("#contenedor2").load('pages/recursos_humanos/cv/consultaRH.php',data3);

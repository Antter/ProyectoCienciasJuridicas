...
if(isset($_POST['identi'])){
    $query = mysql_query("SELECT ID_Experiencia_laboral, Nombre_empresa, Tiempo FROM experiencia_laboral WHERE N_identidad= '".$_POST['identi']."'");
}
?>
<body>
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Lista de Experiencias Laborales</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<script>
    ...
    {
        $("#cuerpoAct").load('pages/recursos_humanos/cv/actualizar/cuerpoActexLab.php', data);

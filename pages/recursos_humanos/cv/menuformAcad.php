<div id="container">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Formación Académica</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <script>
        ...
        var x;
        x = $(document);
        x.ready(menuInicioFormAcad);
        function menuInicioFormAcad()
        {
            var x;
            x = $("#agregar");
            x.click(agregar);
        ...
        {
            $("#container").load('pages/recursos_humanos/cv/nuevo/formAcademica.php');
        }

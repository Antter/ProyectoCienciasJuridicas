<div id="container">
    ...
    <script>
        ...
        var x;
        x = $(document);
        x.ready(menuInicioExpLaboral);
        function menuInicioExpLaboral()
        {
            var x;
            x = $("#agregar");
            x.click(agregar);
        ...
        {
            $("#container").load('pages/recursos_humanos/cv/nuevo/expLaboral.php');
        }
        ...
        {
            $("#container").load('pages/recursos_humanos/cv/eliminar/expLaboral.php');
        }

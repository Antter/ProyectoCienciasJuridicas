...
<div id="container">
    <div class="row">
        <div class="col-lg-10">
            <h1 class="page-header">Menu de busqueda</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row ex2">
             ...
             <div class="panel-group" id="accordion">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <label><span class="glyphicon" aria-hidden="true"></span> Busqueda Generales</label>
                        </h4>
                    </div>
               ...
               <div class="col-lg-3 col-md-6">
                <div class="panel panel-default">
                    ...
                    <a id="BusquedaG" href="#">
                        <div class="panel-footer" data-toggle="modal" data-target="#compose-modal" >
                            ...
                            <div><h2>Descripcion :</h2> <h4>Se hara una busqueda general de todos los perfiles existentes en la base de datos incluye
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <label><span class="glyphicon" aria-hidden="true"></span> Busqueda por solicitante</label>
                        </h4>
                    </div>
                    <div class="panel-body">
                        <div class="col-lg-10">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="panel panel-default">
                    ...
                    <a id="solicitante" href="#">
                        <div class="panel-footer">
                            ...
                            <div><h2>Descripcion :</h2> <h4>  Se hara una busqueda solo de los solicitantes a puestos de trabajo excluyendo a 
                                    los empleados.
                                    </h4></div>
                        </div>
                    </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <label><span class="glyphicon" aria-hidden="true"></span> Busqueda por empleado</label>
                        </h4>
                    </div>
                    <div class="panel-body">
                        <div class="col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    <a id="BusquedaE" href="#">
                        <div class="panel-footer">
                            ...
                            <div><h2>Descripcion :</h2> <h4>Se hara una busqueda solo de los empleados actules excluyendo ex-empleados.
                                    </h4></div>
                        </div>
                    </div>
                </div>
